...
export default function App() {
  ...
  return (
    <div className={`min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 font-sans selection:bg-teal-500/30 selection:text-teal-900 dark:selection:text-teal-200 overflow-x-hidden w-full ${isMounted ? 'transition-colors duration-500' : ''}`}>
      ...
      <AnimatePresence>
        {isModalOpen && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-50 overflow-y-auto bg-black/40 dark:bg-black/60 backdrop-blur-sm"
          ...
          >
            <div className="min-h-full flex items-center justify-center p-4 py-8">
              <motion.div
                ...
                className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl w-full max-w-2xl shadow-2xl relative"
              >
                <button
                  onClick={() => { setIsModalOpen(false); setFormState('idle'); setZiel(""); setIsDropdownOpen(false); }}
      ...
      <header
        className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${isScrolled ? 'bg-white/90 dark:bg-gray-950/90 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 py-4 shadow-lg' : 'bg-transparent py-6'
          }`}
      >
      ...
      <section className="relative pt-24 pb-12 md:pt-32 md:pb-20 lg:pt-48 lg:pb-32 px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <section id="vorteile" className="py-16 md:py-24 bg-white dark:bg-gray-900/30 border-y border-gray-200 dark:border-gray-800">
      ...
      <section id="prozess" className="py-16 md:py-24 px-6 lg:px-8 max-w-7xl mx-auto relative">
        <div className="text-center mb-10 md:mb-16">
      ...
      <section id="reviews" className="py-16 md:py-24 bg-gray-50 dark:bg-gray-900/50 border-y border-gray-200 dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-10 md:mb-16">
          ...
          {/* Logo Bar */}
          <div className="mt-10 md:mt-16 pt-8 md:pt-10 border-t border-gray-200 dark:border-gray-800">
            <p className="text-center text-sm text-gray-500 mb-6 md:mb-8 font-medium">BEKANNT AUS & VERTRAUT VON</p>
      ...
      {/* 5.5 Brand / Haltung */}
      <section className="py-16 md:py-24 bg-gray-950 text-white border-t border-gray-800 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-3xl md:text-5xl font-bold mb-6 md:mb-8 uppercase tracking-tight text-white">Keine typische Agentur.<br /><span className="text-teal-400">Und darauf sind wir stolz.</span></h2>
      ...
      <footer className="relative bg-teal-500 overflow-hidden border-t border-teal-600">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 py-16 md:py-32 text-center">
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-extrabold text-gray-950 mb-4 md:mb-6 tracking-tight uppercase">
          ...
          <button onClick={() => setIsModalOpen(true)} className="group relative inline-flex items-center justify-center bg-gray-950 text-white px-8 py-5 rounded-none font-bold text-lg overflow-hidden transition-transform hover:-translate-y-1 hover:-translate-x-1 shadow-[6px_6px_0px_rgba(0,0,0,0.5)]">
            <span className="relative flex items-center gap-3 font-mono tracking-tight">
              Angebot einholen <ChevronRight size={20} className="text-teal-400" />
            </span>
          </button>
